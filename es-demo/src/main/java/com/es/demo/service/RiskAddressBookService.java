...
//                     addressBook.setRegion("");
//                     addressBook.setRepeatCount(0L);
//                     addressBook.setContactCount(0L);
//                     addressBook.setLastContactTime(new Date());
//                     addressBook.setRelation(3L);
//                     addressBook.setCreateTime(riskAddressBook.getCreateTime());
//                     addressBook.setUpdateTime(riskAddressBook.getCreateTime());
//                     return addressBook;
//                 })
//                 .collect(Collectors.toList());
//
//         // addressBookRepository.saveAll(addressBookList);
//         List<IndexQuery> indexQueryList = addressBookList.stream()
//                 .map(riskAddressBook -> {
//                     IndexQuery indexQuery = new IndexQuery();
//                     indexQuery.setId(String.valueOf(riskAddressBook.getId()));
//                     indexQuery.setObject(riskAddressBook);
//                     return indexQuery;
//                 }).collect(Collectors.toList());
//
